...
<body onload="init_form()">    
    ...
    <form action="post" id="simpan_form">
        <div class="container mt-5">  
            <h3 class="text-header">Normalisasi Kesalahan Nilai</h3>
            ...
            <button type="button" id="btn_process_all" class="btn btn-sm btn-primary text-white btn-shadow"><i class="bi bi-gear"></i> Proses Semua</button>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#btn_process_all', function () {
        ...
        fetch('<?php echo site_url('ujian/normalisasi/proses_normalisasi_salah_nilai') ;?>',{
            method:"POST",
