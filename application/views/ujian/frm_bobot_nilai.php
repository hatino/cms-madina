...
<body>
    ...
    <form action="post" id="simpan_form">
        <div class="container mt-5">              
            <h3 class="text-header header_center">Jumlah Soal dan Bobot Nilai</h3>            
...
<script type="text/javascript">
    ...
    function fetch_tbl_bobot_nilai(){                
        var jenjang = $('#list_jenjang').val() 
        ...
        fetch('<?php echo site_url('ujian/master/get_tbl_bobot_nilai');?>?list_jenjang='+jenjang
    ...
    $(document).on('click', '#btn_simpan', function () {
        ...
        fetch('<?php echo site_url('ujian/master/simpan_bobot_nilai') ;?>', {
            method: "POST",
