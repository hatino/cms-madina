...
<body>
    ...
    <div class="container mt-5">
        ...
        <h3 class="text-header"><strong>Struktur Yayasan</strong></h3>
        <hr style="margin-top: 5px;">
            ...
            <input type="hidden" name="_status_edit" id="_status_edit" value=false> 
                ...
                <div class="card group-sm col-sm-3">                        
                    ...
                    <div class="card-body ">    
                        ...
                        <table>
                            <tr>
                                <td width="200">
                                    <button type="button" class="btn btn-shadow btn-info text-light btn-file btn-sm" onclick="document.getElementById('file_struktur').click()" style="margin-top: 5px;">
                                    ...
                                    <button type="button" class="btn btn-shadow btn-secondary btn-sm" style="margin-top: 5px;" id="kosong_file_struktur"><i class="bi bi-eraser"></i> Batal</button>				
                                </td>
                            </tr>	  		
                        </table>	  	
                ...
                <button type="button" id="btnTambah" class="btn btn-shadow btn-clear btn-sm"><i class="bi bi-file-earmark-plus"></i> Tambah</button>
                <hr>
...
<script type="text/javascript">
    ...
    async function init_form() {        
        ...
        await fetch_tbl_struktur_yayasan()
    }
    ...
    function fetch_tbl_struktur_yayasan(){                 
        fetch('<?php echo site_url('struktur/struktur_admin/get_data_tbl_struktur_yayasan') ;?>').then(function(response){                   
            return response.json();    
        }).then(function (responseData){           
            console.log(responseData) 
            load_tbl_struktur_yayasan(responseData.data);               
        });            
    }
    ...
    $(document).on('click', '#edit_struktur', function () {        
        ...
        var nama =  tbl.rows[row_index].cells[0].innerHTML;
        var jabatan =  tbl.rows[row_index].cells[1].innerHTML;       
        var no_urut = tbl.rows[row_index].cells[2].innerHTML;
    ...
    $(document).on('click', '#delete_struktur', function () {
        ...
        fetch('<?php echo site_url('struktur/struktur_admin/delete_struktur_yayasan') ;?>',{
                    method: 'POST',   
    ...
    $(document).on('submit','#simpan_form', async function () {       
       ...
       fetch('<?php echo site_url('struktur/struktur_admin/simpan_struktur_yayasan') ;?>',{
                   method: 'POST',   
    ...
    async function simpan_img_path(struktur_id) {
       ...
       await fetch('<?php echo site_url('struktur/struktur_admin/simpan_img_path_struktur_yayasan') ;?>',{
                   method: 'POST',   
    ...
    function load_tbl_struktur_yayasan(data) {  
        var html = '';
        html += '<div>';
        ...
        if(data.length>0)
        {
            ...
            {                             
                ...
                html += '   <td style="min-width:180pt">'+data[count].jabatan+'</td>';                
